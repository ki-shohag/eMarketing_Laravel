                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="#" data-toggle="modal"
                        data-target="#editModal"><%=std.title%></a></td>
                      <td><%=std.posted_by%></td>
                      <td>
                        <%=
                                      ...
                                      <div class="modal-body">
                                          <div class="row">
                                              <div class="col">
                                                ...
                                                name="date"
                                                placeholder="Date"
                                                value="<%= std.appointment_date.getFullYear()+'-'+(std.appointment_date.getMonth() < 10 ? '0' : '')+(std.appointment_date.getMonth()+1)+'-'+(std.appointment_date.getDate() < 10 ? '0' : '')+std.appointment_date.getDate() %>"
                                              /><br />
                                              <input
                                                class="form-control"
                                                type="text"
...
<!-- <script>
  var date = new Date(std.appointment_date.creation_date).toISOString().slice(0,10);
