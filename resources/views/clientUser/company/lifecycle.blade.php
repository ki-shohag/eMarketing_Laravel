                ...
                <div class="col col-xl-8 border rounded border-primary">
                    <div class="border-bottom text-center">
                        <label class="mt-4" for=""
                            ><h2><b><%=company.company_name%></b></h2></label
                        ><br />
                        <label class="mt-2" for=""
                            >Phone: <%=company.contact_number%></label
                        ><br />
                    </div>
                </div>
            </div>
                ...
                <div class="row row-xl-12 justify-content-center">
                    <div class="col col-4">
                        <button class="active btn btn-primary btn-block">
                            <a href="/client/company/<%=company.id%>"
                    ...
                    <div class="col col-4">
                        <button class="btn btn-secondary btn-block">
                            <a href="/client/company/<%=company.id%>/services"
                    ...
                    <div class="col col-4">
                        <button class="btn btn-dark btn-block">
                            <a href="/client/company/<%=company.id%>/chat"
                    ...
                    <div class="col col-4">
                        <button class="btn btn-info btn-block">
                            <a
                                href="/client/company/<%=company.id%>/appointments"
                    ...
                    <div class="col col-4">
                        <button class="btn btn-warning btn-block">
                            <a href="/client/company/<%=company.id%>/notes"
                    ...
                    <div class="col col-4">
                        <button class="btn btn-danger btn-block">
                            <a href="/client/company/<%=company.id%>/proposals"
