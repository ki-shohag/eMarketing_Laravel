                    ...
                    <section id="calls-section">
                        <div class="row m-0 p-0">
                            ...
                            <div class="col-6 text-right bg-primary  mb-3 pt-3">
                                <form action="/clients/{{$client['id']}}/calls/add-call" method="post">
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#add-call-modal">
                                        Add New Call
                                    </button>

                                    <!-- Modal -->
                                    <div class="modal text-left fade" id="add-call-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="col-12">
                                <table id="appointmentsTable" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        @for($i = 0; $i < count($calls); $i++) <tr>
                                            <td>{{$calls[$i]['title']}}</td>
                                            <td>{{$calls[$i]['description']}}</td>
                                            <td>{{$calls[$i]['date']}}</td>
                                            <td class="text-center">
                                                <form action="/client/{{$client['id']}}/calls/edit/{{$calls[$i]['id']}}" method="post">
                                                    <!-- Button trigger modal -->
                                                    <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#update-call-modal">
                                                        Edit Call
                                                    </button>

                                                    <!-- Modal -->
                                                    <div class="modal text-left fade" id="update-call-modal" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                ...
                                                <a href="/clients/{{$client['id']}}/calls/delete/{{$calls[$i]['id']}}" class="btn btn-danger ">Delete</a>
                                            </td>
                                            </tr>
                                            @endfor
                                    </tbody>
